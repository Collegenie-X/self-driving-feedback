...
def show_survey():
    ...
    if st.button("설문 제출"):
        ...
        survey_data = {
            ...
            "gender": gender_val,
            "region": region,
            "q1": parse_scale_label(q1_label),
            "q2": parse_scale_label(q2_label),
            "q3": parse_scale_label(q3_label),
            "q4": parse_scale_label(q4_label),
            "q5": parse_scale_label(q5_label),
            "q6": parse_scale_label(q6_label),
            "q7": parse_scale_label(q7_label),
            "q8": parse_scale_label(q8_label),
            "q9": parse_scale_label(q9_label),
            "q10": parse_scale_label(q10_label),
            "q11": parse_scale_label(q11_label),
            "q12": parse_scale_label(q12_label),
            "q13": parse_scale_label(q13_label),
            "q14": parse_scale_label(q14_label),
            "q15": parse_scale_label(q15_label),
            "q16": parse_scale_label(q16_label),
        }
