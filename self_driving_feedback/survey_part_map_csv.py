...
def show_survey():
    ...
    question_groups = [
        ...
        },
        {
            ...
            "question_list": [
                ("Q5. 갑자기 보행자나 자전거가 나타났을 때 빠르게 반응하고 잘 멈추거나 피했나요?", "q5"),
                ("Q6. 예상 못한 앞차의 급정거 같은 긴급 상황에서 믿고 맡길 만큼 시스템이 잘 반응했나요?", "q6"),
                ("Q7. 신호등이나 교통 표지판을 정확히 보고 잘 따르는 편인가요?", "q7"),
                ("Q8. 비가 오거나 밤에 어두울 때도 불안감 없이 안정적으로 주행했나요?", "q8"),
            ]
        },
        {
            ...
            "question_list": [
                ...
                ("Q11. 주차 중 주변 차량이나 기둥 같은 장애물을 잘 파악하고 안전하게 주차했나요?", "q11"),
        ...
        },
        {
            ...
            "question_list": [
                ...
                ("Q14. 자율주행 차량 조작방법이나 사용법이 쉽고 간단하게 느껴졌나요?", "q14"),
