...
def show_survey():
    ...
    if st.button("설문 제출"):
        ...
        ##### }
        ### "q1":{
        ###     "description":"Q1. 큰 도로나 고속도로 주행 시 안정감이 편안했나요?"
        ###     "value_description":"불만족(2)"
        ###     "value":2
        ### }
        ...
        #####     "sub_title": "주행 중 느낀점 (승차감 중심)",
        #####     "question_list": [
        #####         ("Q1. 큰 도로나 고속도로 주행 시 안정감이 편안했나요?", "q1"), q[1]
        #####         ("Q2. 커브길 주행 시 흔들림 없이 편하게 느끼셨나요?", "q2"),
        #####         ("Q3. 좁은 길 주행 시 불안감 없이 안정적으로 느껴졌나요?", "q3"),
        #####         ("Q4. 출발/멈출 때 급하게 흔들리지 않고 자연스러웠나요?", "q4"),
        #####     ],
        ...
        for group in question_groups:
            for q, label in zip(group["question_list"], responses.values()):
                ...
                survey_data[q[1]] = {  ## q2
                    "description": q[
                        0
                    ],  ## Q2. 큰 도로나 고속도로 주행 시 안정감이 편안했나요?"
                    "value_description": label,  ### '보통(4)'
                    "value": parse_scale_label(label),  # 4
                }
